...
This project implements a simple and robust, synthesizable UART (Universal Asynchronous Receiver-Transmitter) IP core in VHDL-93, featuring a Wishbone B4 compatible slave interface. It focuses on a lightweight implementation with configurable baud rates and integrated FIFOs for efficient data handling.
